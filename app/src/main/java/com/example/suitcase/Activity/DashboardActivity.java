...
import com.example.suitcase.Fragments.UserFragment;
import com.example.suitcase.Fragments.HomeFragment;
import com.example.suitcase.Fragments.ManageProductFragment;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.mproduct: {
                        Toast.makeText(DashboardActivity.this,"Manage Product",Toast.LENGTH_SHORT).show();
