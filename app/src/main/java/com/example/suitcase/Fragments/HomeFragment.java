...
import com.example.suitcase.Adapter.CategoryListAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        GridLayoutManager grid = new GridLayoutManager(getContext(), 3, GridLayoutManager.VERTICAL, false);
    ...
    private void addnewcategorydailoge() {
        AlertDialog.Builder addcat = new AlertDialog.Builder(getActivity(), R.style.CustomAlertDialogTheme);
        ...
        addcat.setPositiveButton("add", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (insertCat == -1) {
                    Toast.makeText(getActivity(), "Unable to add category", Toast.LENGTH_SHORT).show();
                } else {
